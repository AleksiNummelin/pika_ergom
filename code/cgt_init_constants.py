def cgt_init_constants():
    ...
    w_det           = -0.0 ### --- AGT change from -4.5 to -0.0    
    ...
    r_doc_rec       = 0.1 ### --- AGT: changed from 0.001 to 0.1   
    global r_don_rec       # recycling rate (don to dic and NH4) at 0°C [1/day]
    r_don_rec       = 0.1 ### --- AGT: changed from 0.001 to 0.1   
    global r_dop_rec       # recycling rate (dop to dic and PO4) at 0°C [1/day]
    r_dop_rec       = 0.1 ### --- AGT: changed from 0.001 to 0.1
